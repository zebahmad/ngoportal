class PaymentRecordsController < ApplicationController
  ...
  private
    ...
    def payment_record_params
      params.require(:payment_record).permit(:donor_name, :status, :received_on, :receipt, :comments, :created_by, :last_updated_by, :created_on, :last_updated_on, :child_sponsorship_id)
    end
end
