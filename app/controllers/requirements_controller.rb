class RequirementsController < ApplicationController
  ...
  def create
    ...
    @requirement.student_id = params[:requirement][:student_id]

    respond_to do |format|
      if @requirement.save
        format.html { 
          flash[:success] = "Requirement succesfully created"
          redirect_to new_requirement_url
        }
  ...
  private
    ...
    def requirement_params
      params.require(:requirement).permit(:student_id, :rtype, :cost, :description)
    end
end
